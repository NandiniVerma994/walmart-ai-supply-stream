...
const DemandDNA = () => {
  const searchTrends = [
    ...
    },
    {
      ...
      change: "+89%",
      source: "TikTok",
      region: "Fitness Communities",
    },
    {
      product: "Portable Fans",
      trendScore: 92,
      change: "+156%",
      source: "Weather Data",
  ...
  const socialSignals = [
    {
      platform: "TikTok",
      signal: "Oat milk latte recipes",
      mentions: "2.3M",
      sentiment: "Positive",
    },
    {
      platform: "Google Trends",
      signal: "Protein powder bulk buy",
      volume: "↑ 234%",
      sentiment: "Growing",
    },
    {
      platform: "Reddit",
      signal: "r/BuyItForLife gaming setup",
      activity: "15K upvotes",
      sentiment: "Strong",
    },
    {
      platform: "Instagram",
      signal: "#airfryerrecipes",
      hashtags: "892K posts",
      sentiment: "Viral",
    },
  ];
  ...
  const suggestedActions = [
    ...
    {
      action: "Bundle Deal",
      product: "Air Fryer + Accessories",
      impact: "High",
      effort: "Medium",
      roi: "+$67K",
    },
    {
      action: "Pre-order Campaign",
      product: "Protein Supplements",
      impact: "Medium",
      effort: "High",
      roi: "+$34K",
    },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">
            🔍 DemandDNA – Predicting Micro-Trends
          </h1>
          <p className="text-lg text-teal-100">
            AI reads the culture and predicts what people will buy next by
            analyzing social signals, search patterns, and cultural movements.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Real-time analysis of emerging product demand
              </CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="text-center space-y-4">
                <div className="text-4xl font-bold text-blue-600">
                  {forecastCard.demandSpike}
                </div>
                <p className="text-gray-700">demand spike expected in</p>
                <p className="text-xl font-semibold text-blue-800">
                  {forecastCard.location}
                </p>
                <div className="space-y-2 text-sm">
                  <p>
                    <span className="font-medium">Product:</span>{" "}
                    {forecastCard.product}
                  </p>
                  <p>
                    <span className="font-medium">Timeline:</span>{" "}
                    {forecastCard.timeline}
                  </p>
                  <p>
                    <span className="font-medium">Confidence:</span>{" "}
                    {forecastCard.confidence}%
                  </p>
                </div>
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Badge
                      className={`${
                        ...
                        signal.sentiment === "Strong"
                          ? "bg-green-100 text-green-800"
                          : signal.sentiment === "Growing" ||
                            signal.sentiment === "Viral"
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <CardDescription>
              Strategic moves to capitalize on emerging trends
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {suggestedActions.map((action, index) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <Button
                      size="sm"
                      className="bg-[#0071ce] hover:bg-[#004c87]"
                    >
                      Execute
                    </Button>
                  </div>
            ...
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
                <div>
                  ...
                  <p>
                    Monitors social media, search trends, and cultural signals
                    across platforms
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    AI processes signals to identify emerging patterns and
                    micro-trends
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Forecasts demand spikes with location and timeline
                    specificity
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Suggests specific actions to capitalize on predicted trends
                  </p>
                </div>
              </div>
            </div>
