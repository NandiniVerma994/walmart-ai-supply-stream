...
export default function WalmartStoreManagerDashboard() {
  ...
  const dashboardCards = [
    {
      ...
      description: "Simulate inventory scenarios and predict outcomes",
      icon: Package,
      color: "bg-blue-500",
      route: "/walmart-store-manager-dashboard/inventory-simulator",
    },
    {
      ...
      icon: RotateCcw,
      color: "bg-red-500",
      route: "/walmart-store-manager-dashboard/returns-radar",
    },
    {
      title: "ShopTrends",
      description: "Analyze demand patterns from social signals",
      icon: TrendingUp,
      color: "bg-purple-500",
      route: "/walmart-store-manager-dashboard/demand-dna",
    },
    {
      title: "Supplier Scoreboard",
      description: "View supplier metrics and performance",
      icon: BarChart3,
      color: "bg-green-500",
      route: "/walmart-store-manager-dashboard/supplier-score",
      readonly: true,
    },
  ];
  ...
  const isOnChildRoute =
    location.pathname !== "/walmart-store-manager-dashboard";
            ...
            <div className="flex items-center space-x-4">
              ...
              {isOnChildRoute && (
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => navigate("/walmart-store-manager-dashboard")}
                  className="text-teal-100 hover:text-white hover:bg-teal-800/50"
                >
                  <ArrowLeft className="w-4 h-4 mr-2" />
                  Back to Dashboard
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-teal-100 max-w-2xl mx-auto">
              Access your store management tools and analytics to optimize
              operations
            </p>
          </div>
                ...
                >
                  ...
                  <CardHeader className="relative z-10 text-center">
                    ...
                    <div className="flex items-center justify-center space-x-2 mb-2">
                      <CardTitle className="text-xl group-hover:text-teal-700 transition-colors duration-300">
                        {card.title}
                      </CardTitle>
                      {card.readonly && (
                        <Badge
                  ...
                  <CardContent className="relative z-10 text-center">
                    <CardDescription className="text-base group-hover:text-gray-700 transition-all duration-300">
                      {card.description}
                    </CardDescription>
                  </CardContent>
                </Card>
