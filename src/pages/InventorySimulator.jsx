      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-teal-100">
            Helps Walmart test inventory moves before they happen using
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card
                className={`${
                  simulationRun ? "bg-green-50 border-green-200" : "bg-gray-50"
              ...
              <Card
                className={`${
                  simulationRun ? "bg-blue-50 border-blue-200" : "bg-gray-50"
                } transition-all duration-500`}
              >
                <CardHeader className="pb-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Historical sales and stock levels
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Temperature correlation and stock analysis
                </CardDescription>
              </CardHeader>
              <CardContent>
